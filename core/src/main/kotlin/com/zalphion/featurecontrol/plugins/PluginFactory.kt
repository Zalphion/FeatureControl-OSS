...
interface PluginFactory<P: Plugin> {
    ...
    fun buildComponentRegistry(json: AutoMarshalling, storage: StorageDriver): ComponentRegistry = ComponentRegistry()
    fun buildLensRegistry(json: AutoMarshalling): LensRegistry = LensRegistry()
}
